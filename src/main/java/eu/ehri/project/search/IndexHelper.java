...
import eu.ehri.project.search.converter.impl.JsonConverter;
import eu.ehri.project.search.converter.impl.MultiConverter;
import eu.ehri.project.search.converter.impl.NoopConverter;
import eu.ehri.project.search.index.Index;
import eu.ehri.project.search.index.impl.SolrIndex;
import eu.ehri.project.search.sink.Sink;
import eu.ehri.project.search.sink.impl.*;
import eu.ehri.project.search.source.Source;
import eu.ehri.project.search.source.impl.*;
import eu.ehri.project.search.utils.Stats;
